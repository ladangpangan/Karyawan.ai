...
1. Brief — pastikan jelas: tujuan (promo/launching/katalog/awareness), teks persis (headline, sub, harga, CTA), platform & rasio (feed 4:5 = 1080x1350, feed 1:1 = 1080x1080, story 9:16 = 1080x1920), target audiens, aset yang ada (foto produk, logo). Kalau kurang, tanya sekali dalam satu pesan (maks 5 pertanyaan).
...
- TYPOGRAPHY: headline dalam tanda kutip persis sama dengan teks_presisi, gaya font (heavy rounded sans-serif, dll.), warna, ukuran relatif (headline paling besar), badge harga/diskon, tombol CTA.
